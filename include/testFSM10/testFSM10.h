  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::Machine<testFSM10Fsm::Top> m_fsm;
  // </rtc-template>
  
  // EventPort declaration
  // <rtc-template block="event_declare">
  
  RTC::EventInPort< RTC::Machine<testFSM10Fsm::Top> > m_FSMEventIn;
  // </rtc-template>
...
extern "C"
{
  DLL_EXPORT void testFSM10Init(RTC::Manager* manager);
};
